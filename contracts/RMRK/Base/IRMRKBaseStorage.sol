...
interface IRMRKBaseStorage is IERC165 {
    ...
    /**
     * @notice Event to announce that z-indexes of given parts have been updated.
     * @dev It is emitted when z-indexes of given parts are updated.
     * @param partId The new, full, list of ID of the parts whose z-index is updated.
     * @param zIndexes The new, full, list of z-index of the parts whose z-index is updated.
     */
