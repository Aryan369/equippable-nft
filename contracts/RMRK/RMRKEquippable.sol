...
import "@rmrk-team/evm-contracts/contracts/RMRK/library/RMRKLib.sol";
import "@rmrk-team/evm-contracts/contracts/RMRK/nesting/RMRKNesting.sol";
import "@rmrk-team/evm-contracts/contracts/RMRK/equippable/IRMRKEquippable.sol";
...
contract RMRKEquippable is RMRKNesting, IRMRKEquippable {
        ...
        returns (string memory)
    {
        ...
        else if (!(index < _activeResources[tokenId].length)){
            revert RMRKIndexOutOfRange();
        }
        else{
